...
It is possible to list all of the versions of `micromamba` available on your platform:
...
```
pixi search micromamba --channel conda-forge/label/micromamba_prerelease
```
